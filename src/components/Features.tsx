...
const features = [
    {
        ...
        href: '/funcionalidades/financeiro' // Link para a página de Finanças
    },
    {
        ...
        accent: 'accent-blue',
        href: '/funcionalidades/estoque' // Link para a página de Estoque
    },
    {
        ...
        href: '/funcionalidades/clientes' // Link para a página de CRM
    },
    {
        ...
        accent: 'accent-amber',
        href: '/funcionalidades/dashboard' // Link para a página de Dashboard
    },
    {
        ...
        stats: 'Venda Mais',
        accent: 'accent-pink',
        href: '/funcionalidades/promocoes' // Link para a página de Promoções
    },
    {
        ...
        accent: 'accent-cyan',
        href: '/funcionalidades/usuarios' // Link para a página de Controle de Usuários
    },
];
                        ...
                        <AnimateInView key={index} delay={index * 0.1}>
                            ...
                            >
                                ...
                                <div className="feature-card-content">
                                    ...
                                    <Link href={feature.href} className="feature-card-link">
                                        Saiba mais
                                        <span>→</span>
                                    </Link>
                                </div>
